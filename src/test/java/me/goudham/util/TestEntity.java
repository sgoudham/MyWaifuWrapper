...
public class TestEntity {
	public static Waifu getExpectedWaifu() {
		...
		List<Series> appearances = new ArrayList<>();
	...
	public static List<FilteredWaifu> getBestWaifus() {
		List<FilteredWaifu> bestWaifus = new ArrayList<>();

		List<FilteredSeries> appearances1 = new ArrayList<>();
		...
		List<FilteredSeries> appearances2 = new ArrayList<>();
		...
		List<FilteredSeries> appearances3 = new ArrayList<>();
		...
		List<FilteredSeries> appearances4 = new ArrayList<>();
		...
		List<FilteredSeries> appearances5 = new ArrayList<>();
		...
		List<FilteredSeries> appearances6 = new ArrayList<>();
		...
		List<FilteredSeries> appearances7 = new ArrayList<>();
		...
		List<FilteredSeries> appearances8 = new ArrayList<>();
		...
		List<FilteredSeries> appearances9 = new ArrayList<>();
		...
		List<FilteredSeries> appearances10 = new ArrayList<>();
